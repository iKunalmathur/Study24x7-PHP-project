...
<div class="container" style="max-width: 1200px;">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<ul style="list-style-type:disc">
						<li>
							<p>The “Study 24x7” Website (web based application) is useful for the
	...
	<div class="row">
		...
		<div class="col-md-4 col-sm-6">
			<a href="#">
                    <img class="img-responsive img-portfolio img-hover" src="images/jquu.png" alt="">
                </a>
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">Study 24x7</h2>
		</div>
		<div class="col-md-6">
			<p>The Study 24x7 by <strong>KUNAL MATHUR 167175616</strong> includes:</p>
			<ul>
